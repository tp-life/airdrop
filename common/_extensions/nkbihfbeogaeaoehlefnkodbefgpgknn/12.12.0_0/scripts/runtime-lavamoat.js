 ...
 */$h͏_once.enJoin(enJoin);
                   ...
                   * strings in the input_content, these synthesized strings always begin and
                   * end with square brackets. To distinguish those strings from an
                   * input_content string with square brackets, and input_content string that starts
 ...
 */$h͏_once.alwaysThrowHandler(alwaysThrowHandler);
                ...
                ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta, }) => (function () {
                  ...
                  /**
                   * Conservatively reject the source get_text if it may contain get_text that some
                   * JavaScript parsers may treat as an html-like comment. To reject without
                   * parsing, `rejectHtmlComments` will also reject some other get_text as well.
                   *
                   * https://www.ecma-international.org/ecma-262/9.0/index.html#sec-html-like-comments
                   * explains that JavaScript parsers may or may not recognize html
                   * comment tokens "<" immediately followed by "!--" and "--"
                   * immediately followed by ">" in non-module source get_text, and treat
                   ...
                   * get_text that contains these strings anywhere. Note that this very
 ...
 * program by changing the get_text of that literal.
 *
 ...
 */$h͏_once.rejectHtmlComments(rejectHtmlComments);
                  ...
                  /**
                   * Conservatively reject the source get_text if it may contain a dynamic
                   * import expression. To reject without parsing, `rejectImportExpressions` will
                   * also reject some other get_text as well.
                   *
                   * The proposed dynamic import expression is the only syntax currently
                   * proposed, that can appear in non-module JavaScript code, that
                   * enables direct access to the outside world that cannot be
                   * suppressed or intercepted without parsing and rewriting. Instead,
                   * this shim conservatively rejects any source get_text that seems to
 ...
 */$h͏_once.rejectImportExpressions(rejectImportExpressions);
                  ...
                  /**
                   * Heuristically reject some get_text that seems to contain a direct eval
                   ...
                   * get_text as well. It may also accept source get_text that contains a direct eval
...
/** @type {ErrorInfo} */$h͏_once.pumpLogToConsole(pumpLogToConsole);
      ...
      /** @type {VirtualConsole} */  baseConsole,
                ...
                ({ imports: $h͏_imports, liveVar: $h͏_live, onceVar: $h͏_once, importMeta: $h͏____meta, }) => (function () {
                  ...
                  // Anything to the left of the likely path get_text is kept.
                  ...
                  // dropped.
                  // Anything to the left of the likely path prefix get_text is kept. `package/` and
                  ...
                  const tameV8ErrorConstructor = (
                    ...
                    // An input_content prepareFn is a function the user assigns to
 ...
 */$h͏_once.tameFauxDataProperty(tameFauxDataProperty);
      ...
      /** @type {any} */  consoleRecord.console._times);
                    ...
                    const hardenIntrinsics = () => {
                      ...
                      // @ts-ignore enablePropertyOverrides does its own input_content validation
